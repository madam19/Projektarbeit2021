    ...
    <div class="container pt-5">
      ...
      <form id="formEmployee" action="sendEmendEmployee.php" method="post">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" placeholder="FamilienName" aria-label="Username" aria-describedby="basic-addon1" name="FamilienName" value="<?= inputEmployee($result, 'FamilienName') ?>">
        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1">VorName</span>
          <input type="text" class="form-control" placeholder="Vorname" aria-label="Username" aria-describedby="basic-addon1" name="Vorname" value="<?= inputEmployee($result, 'Vorname') ?>">
        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1">email</span>
          <input type="text" class="form-control" placeholder="Name_Vorname" aria-label="emailUser" aria-describedby="basic-addon2" name="email" value="<?= inputEmployee($result, 'email') ?>">

        </div>

        <div class="input-group mb-3">
          <span class="input-group-text" id="basic-addon1">password</span>
          <input type="text" class="form-control" placeholder="password" aria-label="emailUser" aria-describedby="basic-addon2" name="password" value="<?= inputEmployee($result, 'password') ?>">
        ...
        <div class="input-group mb-3">
          ...
          <select class="form-select" name="ArbeitsModell" id="inputSelectArbeitsModell">
            <option style="text-align: center" value="0" <?php echo empty($result[0]) ? "selected" : "" ?>>Wählen aus.... </p>
            </option>
            <?php
            //select from BD
            //           var_dump($azm);
        ...
        <div class="input-group mb-3">
          ...
          <table class="table table-primary table-striped table-active table-bordered border-primary">
            ...
            <tbody>
              <tr class="table-primary">
                <td class="table-primary">
                  <input id="inputMontag" type="time" class="form-control" placeholder="Montag" aria-label="Montag" aria-describedby="basic-addon2" name="Montag" value="<?php if (!isset($result[0]['Montag'])) {
                                                                                                                                                                            echo "08:00";
                                                                                                                                                                          } else {
                ...
                <td class="table-primary">
                  <input id="inputDienstag" type="time" class="form-control" placeholder="Dienstag" aria-label="Dienstag" aria-describedby="basic-addon2" name="Dienstag" value="<?php if (!isset($result[0]['Dienstag'])) {
                                                                                                                                                                                    echo "08:00";
                                                                                                                                                                                  } else {
                ...
                <td class="table-primary">
                  <input id="inputMittwoch" type="time" class="form-control" placeholder="Mittwoch" aria-label="Mittwoch" aria-describedby="basic-addon2" name="Mittwoch" value="<?php if (!isset($result[0]['Mittwoch'])) {
                                                                                                                                                                                    echo "08:00";
                                                                                                                                                                                  } else {
                ...
                <td class="table-primary">
                  <input id="inputDonnerstag" type="time" class="form-control" placeholder="Donnerstag" aria-label="Donnerstag" aria-describedby="basic-addon2" name="Donnerstag" value="<?php if (!isset($result[0]['Mittwoch'])) {
                                                                                                                                                                                            echo "08:00";
                                                                                                                                                                                          } else {
                ...
                <td class="table-primary">
                  <input id="inputFreitag" type="time" class="form-control" placeholder="Freitag" aria-label="Freitag" aria-describedby="basic-addon2" name="Freitag" value="<?php if (!isset($result[0]['Freitag'])) {
                                                                                                                                                                                echo "05:30";
                                                                                                                                                                              } else {
        ...
        <div class="input-group mb-3 end">
          <div class="input-group-text">
            <input id="rolles" class="form-check-input mt-0" type="checkbox" name="rolles" <?php if (isset($result[0]["rolles_ID"]) && $result[0]["rolles_ID"] == "1") {
                                                                                              echo "checked";
                                                                                              $rolles = "1";
                                                                                            } ?> aria-label="user">
          </div>
        ...
        <div class="input-group mb-3">
          ...
          <input type="text" class="form-control" placeholder="12345" aria-label="personalNR" aria-describedby="basic-addon1" name="personalNR" value="<?= inputEmployee($result, 'personalNR') ?>">
        </div>
        ...
        <div class="input-group mb-3">
          ...
          <select class="form-select" name="abteilung" id="inputSelectAbteilung">
            <option style="text-align: center" value="0" ">Wählen aus.... </p></option>
                <?php
                //select from BD
