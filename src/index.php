...
// display an error if the password and email are incorrect
...
if (isset($_REQUEST['submit'])) {
  ...
  } else { // eingabe richtig - gehe weiter
    // $_SESSION setzen
      ...
      <div class="col-6 p-5">
        <div class="row">
          <form action="?submit" method="post">
            <!--input email-->
            <div class="mb-3">
              <input type="email" class="form-control" name="emailUser" id="inputEmail1" placeholder="deine@email.de" value="">
            </div>
            <!-- input password -->
            <div class="mb-3">
              <input type="password" name="passwordUser" placeholder="Password" value="">
            </div>
